  ...
  return (
    <AudioPlayerProvider>
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger render={<Button variant="outline" role="combobox" aria-expanded={isOpen} className={cn("w-full justify-between", className)} />}>{selectedVoice ? (
                            ...
                            placeholder
                          )}<ChevronsUpDown className="ml-2 size-4 shrink-0 opacity-50" /></PopoverTrigger>
